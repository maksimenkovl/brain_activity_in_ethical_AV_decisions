...
%----------------dataset-------------------------
dataset='40_text_raw.edf' %name of the current dataset


%------------------------protocol--------------------------
protocol_name='protocol_40_Text.xlsx' %name of the protocol file


%------------------------Import EDF-----------------------------
%addpath /Users/maksimenko/Dropbox/!Hein/!FINAL_DATA
cfg            = [];
cfg.dataset    = dataset; 
cfg.continuous = 'yes';
...
%cfg.trials     = 1;
cfg.foi        = 4:0.25:30;
cfg.toi        = 0.5:0.003:16.5; %set time for video and text
cfg.width      = cfg.foi;
cfg.output     = 'pow';
cfg.keeptrials = 'yes';
...
%filepath = '/Users/maksimenko/Dropbox/!Hein/!FINAL_DATA/MATLAB_OUTPUT/';
filename = strcat(name_var,'_','theta','_Text','.mat');
...
filename = strcat(name_var,'_','alpha','_Text','.mat');
...
filename = strcat(name_var,'_','beta','_Text','.mat');
save(filename,'beta_')
